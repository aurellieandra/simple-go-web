...
func GetAll() []entitites.Category {
	...
	var categories []entitites.Category

	for rows.Next() {
		var category entitites.Category
...
func Create(category entitites.Category) bool {
...
func Detail(id int) entitites.Category {
...
func Update(id int, category entitites.Category) bool {
